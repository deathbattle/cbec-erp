...
class TiktokOrderViewSet(CustomModelViewSet):
    ...
    export_field_label = {
        ...
        "currency_unit": "货币单位",
        "order_quantity": "下单件数",
        "is_refunded": "已全部退货或全额退�?,
        "payment_method": "付款方式",
        "order_status": "订单状�?,
        "influencer_username": "达人用户�?,
        "content_type": "内容形式",
        "content_id": "内容ID",
        "commission_model": "佣金模型",
        "standard_commission_rate": "标准佣金�?,
        ...
        "store_ad_commission_rate": "店铺广告佣金�?,
    ...
    import_field_dict = {
        ...
        "currency_unit": "货币单位",
        "order_quantity": "下单件数",
        "is_refunded": {"title": "已全部退货或全额退�?, "choices": {"data": {"�?: True, "�?: False}}},
        "payment_method": "付款方式",
        "order_status": "订单状�?,
        "influencer_username": "达人用户�?,
        "content_type": "内容形式",
    ...
    def create(self, request, *args, **kwargs):
        ...
        # 创建主订�?        order = TiktokOrder.objects.create(
    ...
    def update(self, request, *args, **kwargs):
        ...
        # 更新主订�?        instance.payment_amount = request.data.get('payment_amount', instance.payment_amount)
...
class ShangmaOrderViewSet(CustomModelViewSet):
    ...
    export_field_label = {
        ...
        "third_order_time": "第三方订单时�?,
        "third_order_status": "第三方订单状�?,
        "payment_method": "支付方式",
        "logistics_no": "物流单号",
        ...
        "third_shipping_discount": "第三方运费优�?,
        "seller_shipping_discount": "卖家运费优惠",
        "actual_shipping_fee": "实际运费",
        "final_shipping_fee": "最终运�?,
        "voucher_from_platform": "平台优惠�?,
        "voucher_from_seller": "卖家优惠�?,
        "commission_fee": "佣金费用",
        "service_fee": "服务费用",
        "other_fee": "其他费用",
