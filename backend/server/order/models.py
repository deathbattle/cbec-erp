...
class TiktokOrder(CoreModel):
    ...
    is_refunded = models.BooleanField(default=False, verbose_name="已全部退货或全额退�?, help_text="已全部退货或全额退�?)
    payment_method = models.CharField(max_length=50, verbose_name="付款方式", help_text="付款方式", null=True, blank=True)
    order_status = models.CharField(max_length=50, verbose_name="订单状�?, help_text="订单状�?, null=True, blank=True)
...
class TiktokOrderInfluencer(CoreModel):
    ...
    """
    order = models.ForeignKey(to="TiktokOrder", on_delete=models.CASCADE, verbose_name="关联订单", help_text="关联订单", db_constraint=False)
    influencer_username = models.CharField(max_length=100, verbose_name="达人用户�?, help_text="达人用户�?, null=True, blank=True)
...
class TiktokOrderCommission(CoreModel):
    ...
    standard_commission_rate = models.DecimalField(max_digits=10, decimal_places=4, verbose_name="标准佣金�?, help_text="标准佣金�?, null=True, blank=True)
    ...
    store_ad_commission_rate = models.DecimalField(max_digits=10, decimal_places=4, verbose_name="店铺广告佣金�?, help_text="店铺广告佣金�?, null=True, blank=True)
...
class ShangmaOrder(CoreModel):
    ...
    order_no = models.CharField(max_length=64, verbose_name="订单�?, help_text="订单�?, db_index=True)
    third_order_no = models.CharField(max_length=64, verbose_name="第三方订单号", help_text="第三方订单号", null=True, blank=True)
    third_order_time = models.DateTimeField(verbose_name="第三方订单时�?, help_text="第三方订单时�?, null=True, blank=True)
    third_order_status = models.CharField(max_length=50, verbose_name="第三方订单状�?, help_text="第三方订单状�?, null=True, blank=True)
    ...
    third_shipping_discount = models.DecimalField(max_digits=18, decimal_places=2, verbose_name="第三方运费优�?, help_text="第三方运费优�?, null=True, blank=True)
    ...
    final_shipping_fee = models.DecimalField(max_digits=18, decimal_places=2, verbose_name="最终运�?, help_text="最终运�?, null=True, blank=True)
    voucher_from_platform = models.DecimalField(max_digits=18, decimal_places=2, verbose_name="平台优惠�?, help_text="平台优惠�?, null=True, blank=True)
    voucher_from_seller = models.DecimalField(max_digits=18, decimal_places=2, verbose_name="卖家优惠�?, help_text="卖家优惠�?, null=True, blank=True)
    ...
    order_status = models.IntegerField(default=0, verbose_name="订单状�?, help_text="订单状�?, null=True, blank=True)
