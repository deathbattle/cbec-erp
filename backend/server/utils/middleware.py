...
from server.system.models import OperationLog
from server.utils.request_util import get_request_user, get_request_ip, get_request_data, get_request_path, get_os, \
...
class ApiLoggingMiddleware(MiddlewareMixin):
    ...
    def __handle_response(self, request, response):
        # request_data,request_ip由PermissionInterfaceMiddleware中间件中添加的属�?        body = getattr(request, 'request_data', {})
        # 请求含有password则用*替换�?暂时先用于所有接口的password请求参数)
