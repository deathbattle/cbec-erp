...
from server.utils.models import CoreModel, table_prefix, get_custom_app_models
...
class LoginLog(CoreModel):
    ...
    continent = models.CharField(max_length=50, verbose_name="洲", null=True, blank=True, help_text="洲")
...
class MessageCenterTargetUser(CoreModel):
    ...
    messagecenter = models.ForeignKey(MessageCenter, on_delete=models.CASCADE, db_constraint=False,
                                      verbose_name="关联消息中心", help_text="关联消息中心")
