...
from server.system.models import Menu, Users, Dept, Role, ApiWhiteList, Dictionary, SystemConfig
from server.system.fixtures.initSerializer import UsersInitSerializer, DeptInitSerializer, RoleInitSerializer, \
...
class Command(BaseCommand):
    """
    生产初始化菜�? python3 manage.py generate_init_json 生成初始化的model�?    例如�?    全部生成：python3 manage.py generate_init_json
