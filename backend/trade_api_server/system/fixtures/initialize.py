...
from trade_api_server.utils.core_initialize import CoreInitialize
from trade_api_server.system.fixtures.initSerializer import (
...
if __name__ == "__main__":
    Initialize(app='trade_api_server.system').run()
