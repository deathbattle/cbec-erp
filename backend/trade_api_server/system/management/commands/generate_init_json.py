...
from trade_api_server.system.models import Menu, Users, Dept, Role, ApiWhiteList, Dictionary, SystemConfig
from trade_api_server.system.fixtures.initSerializer import UsersInitSerializer, DeptInitSerializer, RoleInitSerializer, \
