...
interface CommonCrudOptions {
    create_datetime?: FieldOptions;
    update_datetime?: FieldOptions;
    creator_name?: FieldOptions;
    modifier_name?: FieldOptions;
    dept_belong_id?: FieldOptions;
    description?: FieldOptions;
}

export const commonCrudConfig = (options: CommonCrudOptions = {}) => {
    return {
        dept_belong_id: {
            title: '所属部门',
            type: 'dict-tree',
