...
import { InsertOrderParamsType, DeleteOrderParamsType } from './types'

export const apiPrefix = '/api/system/user/';

export function InserOrder(params: InsertOrderParamsType) {
    return request({
        url: "/api/trade/esunny/order/",
        method: 'put',
        data: params,
    });
}

export function DeleteOrder(params: DeleteOrderParamsType) {
    return request({
        url: "/api/trade/esunny/order/",
        method: 'delete',
        data: params,
